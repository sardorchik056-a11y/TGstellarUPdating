...
# ── Админка — все админские команды и кнопки (/add, /getallart, /giveart,
# /deletebd, /addcheck, /addpromo, /rass и т.д.) вынесены в admin.py.
# Импорт нужен, чтобы её хендлеры зарегистрировались на общем dp. ──
import admin
