...
#  15 уникальных питомцев-шахтёров
...
_PET_EMOJI = {
    ...
    # dragon — без кастомного emoji, используется обычный юникод "🐲" (см. pet["emoji"])
    "yeti":    "5440881179211347123",
    "phoenix": "6273868499764906792",
    "octopus": "5429436568836260201",
    "sphinx":  "5192671209539519639",
}
...
_PETS_MENU_TEXTS_EN = [
    ...
    "The dragon keeps a ledger of who owes him what. Everyone owes him something.",
    "The yeti still hasn't warmed up. Still hasn't stopped digging either.",
    "The phoenix burned out again. Back on shift by morning, as usual.",
    "The octopus is doing inventory with all eight arms at once. It always checks out.",
    "The sphinx said one sentence this week. It was worth more than the mine's daily output.",
]
...
PETS = [
    ...
    {"key":"dragon","name":"Дракон-Ростовщик","name_en":"Loan Shark Dragon","emoji":"🐲",
     "desc":"<b>Хранит золото в подземных залах.</b>\n<b>Выдаёт «в долг под проценты», хотя никто не просил.</b>",
     "desc_en":"<b>Guards gold in underground halls.</b>\n<b>Lends it out «with interest», though nobody asked.</b>",
     "price":45_000_000_000,"rarity":"Мифический","rarity_en":"Mythic",
     "bonus":"<b>Находит гранит и алмазы</b>","bonus_en":"<b>Finds granite and diamonds</b>",
     "income_min":400_000_000,"income_max":770_000_000},
    {"key":"yeti","name":"Йети-Кладоискатель","name_en":"Treasure Yeti","emoji":"🥶",
     "desc":"<b>Спустился с ледника специально за рудой.</b>\n<b>До сих пор не может согреться, но копает исправно.</b>",
     "desc_en":"<b>Came down from the glacier just for the ore.</b>\n<b>Still can't warm up, but keeps digging anyway.</b>",
     "price":130_000_000_000,"rarity":"Божественный","rarity_en":"Divine",
     "bonus":"<b>Ускоряет добычу нефрита и изумруда</b>","bonus_en":"<b>Speeds up jade and emerald mining</b>",
     "income_min":1_000_000_000,"income_max":2_000_000_000},
    {"key":"phoenix","name":"Феникс Второй Смены","name_en":"Second-Shift Phoenix","emoji":"🔥",
     "desc":"<b>Сгорает к концу дня, возрождается к следующей смене.</b>\n<b>Больничных не берёт.</b>",
     "desc_en":"<b>Burns out by the end of the day, reborn for the next shift.</b>\n<b>Never takes sick leave.</b>",
     "price":400_000_000_000,"rarity":"Божественный","rarity_en":"Divine",
     "bonus":"<b>Выжигает породу — открывает обсидиан</b>","bonus_en":"<b>Scorches rock — reveals obsidian</b>",
     "income_min":2_800_000_000,"income_max":5_200_000_000},
    {"key":"octopus","name":"Осьминог-Бухгалтер","name_en":"Accountant Octopus","emoji":"🐙",
     "desc":"<b>Восемь щупалец — восемь кирок одновременно.</b>\n<b>Ведёт учёт добычи до последней монеты.</b>",
     "desc_en":"<b>Eight tentacles — eight pickaxes at once.</b>\n<b>Tracks every last coin of the haul.</b>",
     "price":1_200_000_000_000,"rarity":"Абсолютный","rarity_en":"Absolute",
     "bonus":"<b>Находит сапфир на дне шахтных вод</b>","bonus_en":"<b>Finds sapphire at the bottom of mine waters</b>",
     "income_min":7_500_000_000,"income_max":14_000_000_000},
    {"key":"sphinx","name":"Сфинкс — Хранитель Тайн","name_en":"Sphinx, Keeper of Secrets","emoji":"🗿",
     "desc":"<b>Самый загадочный из всех.</b>\n<b>Находит то, что остальные даже не ищут.</b>",
     "desc_en":"<b>The most mysterious of them all.</b>\n<b>Finds what the others don't even look for.</b>",
     "price":3_800_000_000_000,"rarity":"Абсолютный","rarity_en":"Absolute",
     "bonus":"<b>Повышает шанс всех скрытых руд разом</b>","bonus_en":"<b>Boosts the chance of all hidden ores at once</b>",
     "income_min":20_000_000_000,"income_max":40_000_000_000},
]
...
_NOTIFICATIONS = {
    ...
    "dragon": [
        "🐲 <b>Дракон-Ростовщик</b> <b>выдал шахте «кредит» породой под честное слово. Проценты — монетами тебе.</b>",
        "🐲 <b>Дракон-Ростовщик</b> <b>пересчитал сокровищницу в третий раз за день. Недостачи нет. Прибыль есть.</b>",
        "🐲 <b>Дракон-Ростовщик</b> <b>вздремнул на груде гранита. Проснулся — груда стала больше.</b>",
        "🐲 <b>Дракон-Ростовщик</b> <b>обменял один алмаз на два у нового шахтёра. Шахтёр не заметил подвоха. Ты заметил прибыль.</b>",
        "🐲 <b>Дракон-Ростовщик</b> <b>дыхнул на скалу. Скала расплавилась и открыла жилу.</b>",
        "🐲 <b>Дракон-Ростовщик</b> <b>завёл долговую книгу на всю шахту. Читать её страшно. Доход исправный.</b>",
        "🐲 <b>Дракон-Ростовщик</b> <b>согласился «одолжить» немного золота. Обратно почему-то попросил больше, чем дал.</b>",
    ],
    "yeti": [
        _n("5440881179211347123","🥶","Йети-Кладоискатель","спустился ещё на километр вниз. Там теплее и есть нефрит."),
        _n("5440881179211347123","🥶","Йети-Кладоискатель","отогрелся о жерло вулканической жилы. Заодно набрал изумрудов."),
        _n("5440881179211347123","🥶","Йети-Кладоискатель","оставил ледяные следы прямо в забое. Рядом — свежая добыча."),
        _n("5440881179211347123","🥶","Йети-Кладоискатель","до сих пор не понимает, зачем спускался с гор. Но приносит исправно."),
        _n("5440881179211347123","🥶","Йети-Кладоискатель","укутался в собственную шерсть и продолжил копать. Замёрз, но не сдался."),
        _n("5440881179211347123","🥶","Йети-Кладоискатель","нашёл нефритовую жилу и попытался согреться об неё. Не помогло. Монеты помогли."),
        _n("5440881179211347123","🥶","Йети-Кладоискатель","говорит, что там наверху теплее. Всё равно остаётся внизу — работать.")
    ],
    "phoenix": [
        _n("6273868499764906792","🔥","Феникс Второй Смены","сгорел дотла в полночь. К утру снова на смене, как ни в чём не бывало."),
        _n("6273868499764906792","🔥","Феникс Второй Смены","выжег кусок породы дотла. На пепелище — обсидиан."),
        _n("6273868499764906792","🔥","Феникс Второй Смены","возродился уже третий раз за неделю. Больничный не оформлял ни разу."),
        _n("6273868499764906792","🔥","Феникс Второй Смены","осветил тоннель собственным пламенем. Заодно нашёл всё, что там блестело."),
        _n("6273868499764906792","🔥","Феникс Второй Смены","говорит, что «просто немного припекло». Судя по добыче — не немного."),
        _n("6273868499764906792","🔥","Феникс Второй Смены","восстал из пепла с полными руками руды. Обычный день."),
        _n("6273868499764906792","🔥","Феникс Второй Смены","закончил смену, сгорел, начал следующую. Никто в шахте так и не понял график."),
    ],
    "octopus": [
        _n("5429436568836260201","🐙","Осьминог-Бухгалтер","копал сразу восемью кирками. Сверил итог — сошлось до монеты."),
        _n("5429436568836260201","🐙","Осьминог-Бухгалтер","нашёл сапфир на дне шахтного колодца. Занёс в отчёт немедленно."),
        _n("5429436568836260201","🐙","Осьминог-Бухгалтер","вёл учёт добычи всех питомцев разом. Заодно накопал сам."),
        _n("5429436568836260201","🐙","Осьминог-Бухгалтер","обнаружил ошибку в собственных расчётах. Исправил в свою пользу твою."),
        _n("5429436568836260201","🐙","Осьминог-Бухгалтер","разложил находки по восьми кучкам. Все восемь оказались прибыльными."),
        _n("5429436568836260201","🐙","Осьминог-Бухгалтер","составил смету на следующую смену. Смета сбылась с запасом."),
        _n("5429436568836260201","🐙","Осьминог-Бухгалтер","провёл инвентаризацию шахты восемью щупальцами одновременно. Быстро и точно."),
    ],
    "sphinx": [
        _n("5192671209539519639","🗿","Сфинкс — Хранитель Тайн","задал шахте загадку. Шахта ответила рудой."),
        _n("5192671209539519639","🗿","Сфинкс — Хранитель Тайн","нашёл то, что никто даже не искал. Не объяснил как. Просто принёс."),
        _n("5192671209539519639","🗿","Сфинкс — Хранитель Тайн","молчал тысячу лет. Заговорил один раз — и указал на скрытую жилу."),
        _n("5192671209539519639","🗿","Сфинкс — Хранитель Тайн","знает ответы на все вопросы шахты. Отвечать не любит. Копать — любит."),
        _n("5192671209539519639","🗿","Сфинкс — Хранитель Тайн","открыл тайну, которую хранил веками. Тайна оказалась залежью руды."),
        _n("5192671209539519639","🗿","Сфинкс — Хранитель Тайн","провёл ритуал у входа в шахту. Никто не понял слов. Все поняли результат."),
        _n("5192671209539519639","🗿","Сфинкс — Хранитель Тайн","смотрел в темноту тоннеля не моргая. Темнота моргнула первой и отдала находку."),
    ],
}
...
# 15 уникальных случайных текстов для раздела питомцев
_PETS_MENU_TEXTS = [
    ...
    "Дракон завёл долговую книгу на всю шахту. Должны ему, кажется, все.",
    "Йети так и не согрелся. Копать это ему не мешает.",
    "Феникс снова сгорел. К утру уже на смене, как обычно.",
    "Осьминог ведёт учёт восемью щупальцами разом. Сходится всегда.",
    "Сфинкс сказал одну фразу за неделю. Она стоила больше дневной добычи шахты.",
]
