...
_E = {
    ...
    "antimatter":   None,  # антиматерия (личная валюта, см. shop.CASE_TIERS) — ID оказался
                            # битым/несуществующим (DOCUMENT_INVALID при награде за убийство
                            # босса). Пока None — покажется обычный emoji 🟣 (fallback).
                            # TODO: вставить сюда свой РЕАЛЬНЫЙ id премиум-эмодзи.
}
