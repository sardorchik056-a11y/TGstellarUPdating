...
_E = {
    ...
    "elite":        None,  # метка элитного босса — ID не существует в Telegram (подтверждено
                            # через getCustomEmojiStickers), из-за него падал DOCUMENT_INVALID
                            # на элитных боссах. Пока None — покажется обычный emoji 🔥 (fallback).
                            # TODO: вставить сюда свой РЕАЛЬНЫЙ id премиум-эмодзи.
    "vulnerable":   None,  # окно уязвимости босса — БЫЛ БИТЫЙ ID (заглушка "...0987654321",
                            # не настоящий custom-emoji ID), из-за него падала отправка
...
SWORD_EMOJIS = {
    ...
    "apocalypse_scythe":   "5764706345936753058",
    "heart_of_chaos":      "6026365473120063714",
    "verdict_of_infinity": "5363944425015756883",
    "leviathans_fang":     "5242266240583484112",
    "seal_of_the_creator": "5238215781480671890",
    "world_breaker":       "5888712720471037332",
    "echo_of_nonexistence":"5364165100435419042",
    "the_last_light":      "5220195537520711716",
    "tyrants_blade":       "5345826732542814577",
    "blood_of_creation":   "5303017736941622221",
}
...
def _tg(eid, fb=""):
    # Если id пустой/битый — просто отдаём обычный юникод-эмодзи без обёртки
    # <tg-emoji>. Иначе Telegram при отправке сообщения ищет документ с таким
    # ID в своей базе кастомных эмодзи и, если не находит (несуществующий/
    # заглушечный ID), валит всё сообщение ошибкой DOCUMENT_INVALID.
    if not eid:
        return fb
...
SWORDS = [
    ...
    },
    {
        ...
        "dmg_min": 6_900, "dmg_max": 9_700,
        "crit_chance": 0.05, "crit_mult": 2.0,
        "price": 5_000_000_000,
    },
    {
        "key": "apocalypse_scythe",
        "name": "Коса Апокалипсиса", "name_en": "Apocalypse Scythe",
        "emoji_id": SWORD_EMOJIS["apocalypse_scythe"],
        "desc": "<b><i>Не меч — приговор всему живому.</i></b>\n<b><i>Каждый взмах стирает целую эпоху.</i></b>",
        "desc_en": "<b><i>Not a sword — a verdict upon all living things.</i></b>\n<b><i>Each swing erases an entire epoch.</i></b>",
        "dmg_min": 8_300, "dmg_max": 11_000,
        "crit_chance": 0.05, "crit_mult": 2.0,
        "price": 12_000_000_000,
    },
    {
        "key": "tyrants_blade",
        "name": "Клинок Тирана", "name_en": "Tyrant's Blade",
        "emoji_id": SWORD_EMOJIS["tyrants_blade"],
        "desc": "<b><i>Каждый тиран желал взять его в руки.</i></b>\n<b><i>Никто не пережил это желание.</i></b>",
        "desc_en": "<b><i>Every tyrant longed to wield it.</i></b>\n<b><i>None survived that desire.</i></b>",
        "dmg_min": 10_000, "dmg_max": 13_200,
        "crit_chance": 0.05, "crit_mult": 2.0,
        "price": 25_000_000_000,
    },
    {
        "key": "heart_of_chaos",
        "name": "Сердце Хаоса", "name_en": "Heart of Chaos",
        "emoji_id": SWORD_EMOJIS["heart_of_chaos"],
        "desc": "<b><i>Бьётся вместо человеческого сердца в груди того, кто им владеет.</i></b>\n<b><i>Каждый удар — вспышка первозданного хаоса.</i></b>",
        "desc_en": "<b><i>It beats where a human heart should be.</i></b>\n<b><i>Every strike is a flash of primordial chaos.</i></b>",
        "dmg_min": 12_600, "dmg_max": 15_800,
        "crit_chance": 0.05, "crit_mult": 2.0,
        "price": 50_000_000_000,
    },
    {
        "key": "verdict_of_infinity",
        "name": "Приговор Бесконечности", "name_en": "Verdict of Infinity",
        "emoji_id": SWORD_EMOJIS["verdict_of_infinity"],
        "desc": "<b><i>Бесконечность имела начало.</i></b>\n<b><i>У него будет и конец.</i></b>",
        "desc_en": "<b><i>Infinity had a beginning.</i></b>\n<b><i>It will have an end too.</i></b>",
        "dmg_min": 14_200, "dmg_max": 17_500,
        "crit_chance": 0.05, "crit_mult": 2.0,
        "price": 100_000_000_000,
    },
    {
        "key": "leviathans_fang",
        "name": "Клык Левиафана", "name_en": "Leviathan's Fang",
        "emoji_id": SWORD_EMOJIS["leviathans_fang"],
        "desc": "<b><i>Вырван из пасти существа, что спит на дне мироздания.</i></b>\n<b><i>Оно ещё проснётся.</i></b>",
        "desc_en": "<b><i>Torn from the jaws of a beast sleeping at the bottom of creation.</i></b>\n<b><i>It will wake.</i></b>",
        "dmg_min": 17_000, "dmg_max": 21_000,
        "crit_chance": 0.05, "crit_mult": 2.0,
        "price": 200_000_000_000,
    },
    {
        "key": "seal_of_the_creator",
        "name": "Печать Творца", "name_en": "Seal of the Creator",
        "emoji_id": SWORD_EMOJIS["seal_of_the_creator"],
        "desc": "<b><i>Им был подписан первый закон мира.</i></b>\n<b><i>Им же будет подписан последний.</i></b>",
        "desc_en": "<b><i>The first law of the world was signed with it.</i></b>\n<b><i>So will the last.</i></b>",
        "dmg_min": 19_000, "dmg_max": 24_000,
        "crit_chance": 0.05, "crit_mult": 2.0,
        "price": 400_000_000_000,
    },
    {
        "key": "world_breaker",
        "name": "Разрушитель Миров", "name_en": "World Breaker",
        "emoji_id": SWORD_EMOJIS["world_breaker"],
        "desc": "<b><i>Не разрубает — стирает.</i></b>\n<b><i>То, что он коснулся, перестаёт существовать.</i></b>",
        "desc_en": "<b><i>It doesn't cleave — it erases.</i></b>\n<b><i>What it touches ceases to exist.</i></b>",
        "dmg_min": 23_000, "dmg_max": 28_000,
        "crit_chance": 0.05, "crit_mult": 2.0,
        "price": 800_000_000_000,
    },
    {
        "key": "blood_of_creation",
        "name": "Кровь Мироздания", "name_en": "Blood of Creation",
        "emoji_id": SWORD_EMOJIS["blood_of_creation"],
        "desc": "<b><i>Им пролита первая кровь мира.</i></b>\n<b><i>Им будет пролита последняя.</i></b>",
        "desc_en": "<b><i>It spilled the world's first blood.</i></b>\n<b><i>It will spill the last as well.</i></b>",
        "dmg_min": 27_000, "dmg_max": 32_000,
        "crit_chance": 0.05, "crit_mult": 2.0,
        "price": 1_500_000_000_000,
    },
    {
        "key": "echo_of_nonexistence",
        "name": "Эхо Небытия", "name_en": "Echo of Nonexistence",
        "emoji_id": SWORD_EMOJIS["echo_of_nonexistence"],
        "desc": "<b><i>Существует там, где ничего не должно существовать.</i></b>\n<b><i>Его звон слышен даже в пустоте.</i></b>",
        "desc_en": "<b><i>It exists where nothing should.</i></b>\n<b><i>Its ring echoes even through the void.</i></b>",
        "dmg_min": 31_000, "dmg_max": 37_000,
        "crit_chance": 0.05, "crit_mult": 2.0,
        "price": 3_000_000_000_000,
    },
    {
        "key": "the_last_light",
        "name": "Последний Свет", "name_en": "The Last Light",
        "emoji_id": SWORD_EMOJIS["the_last_light"],
        "desc": "<b><i>Когда погаснут все звёзды, останется только он.</i></b>\n<b><i>Последний свет перед вечной тьмой.</i></b>",
        "desc_en": "<b><i>When every star goes dark, only this remains.</i></b>\n<b><i>The last light before eternal night.</i></b>",
        "dmg_min": 38_000, "dmg_max": 45_000,
        "crit_chance": 0.05, "crit_mult": 2.0,
...
def _get_conn():
    # Та же БД (tgstellar.db), что и в database.py/klan.py — используем те же
    # PRAGMA (WAL + busy_timeout=30s), иначе это соединение открывается с
    # дефолтным SQLite busy-timeout 5с и без WAL, из-за чего при параллельной
    # нагрузке (несколько игроков одновременно) оно ловит "database is locked"
    # / подвисает на конкурентных записях из других модулей и не успевает
    # ответить на callback (Telegram отбрасывает такой ответ как "too old").
