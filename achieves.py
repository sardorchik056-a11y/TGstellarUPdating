...
def _bump_achievement_count(ach_id: str) -> None:
    ...
    ВАЖНО: check_achievements() — синхронная функция, вызываемая напрямую
    (без asyncio.to_thread) из ~80 мест по всему mainhelp.py на КАЖДОЕ
    игровое действие. Если бы этот sqlite3-запрос выполнялся тут же —
    любое новое открытие ачивки любым игроком морозило бы event loop бота
    для всех остальных на время диск-I/O (тот же класс бага, что был с
    track_user/get_all_users в других модулях). Переписывать все 80+
    call-сайтов на await — слишком рискованно, поэтому вместо этого сам
    диск-I/O уводится в отдельный демон-поток "по-факту" (fire-and-forget):
    открытие ачивки в data[...] уже применилось синхронно и мгновенно,
    а глобальный счётчик "сколько игроков открыли" — штука не критичная
    к таймингу, ей ничего не будет от асинхронного +1 чуть позже.
    """
    def _write():
        try:
            conn = _sqlite3.connect(_ACH_DB_PATH)
...
ACHIEVEMENTS = [
    ...
    _ach("level_10", "🔹", "Уверенный старт",
         ...
         name_en='Confident Start', desc_en='Reach level 10'),
    ...
    _ach("level_25", "🔷", "Опытный игрок",
         ...
         name_en='Seasoned Player', desc_en='Reach level 25'),
    ...
    _ach("level_50", "💠", "Ветеран",
         ...
         name_en='Veteran', desc_en='Reach level 50'),
    ...
    _ach("level_75", "🔶", "Легенда",
         ...
         name_en='Legend', desc_en='Reach level 75'),
    ...
    _ach("level_max", "🏵", "Живая легенда",
         ...
         name_en='Living Legend', desc_en='Reach the maximum level'),
    ...
    _ach("mine_1", "⛏", "Первая вылазка",
         ...
         name_en='First Expedition', desc_en='Complete your first mining expedition'),
    ...
    _ach("mine_10", "🪨", "Трудяга",
         ...
         name_en='Hard Worker', desc_en='Complete 10 mining expeditions'),
    ...
    _ach("mine_100", "⚒️", "Шахтёр по призванию",
         ...
         name_en='Born Miner', desc_en='Complete 100 mining expeditions'),
    ...
    _ach("mine_500", "🏔", "Король забоя",
         ...
         name_en='King of the Pit', desc_en='Complete 500 mining expeditions'),
    ...
    _ach("mine_2500", "🕳", "Легенда подземелья",
         ...
         name_en='Legend of the Depths', desc_en='Complete 2,500 mining expeditions'),
    ...
    _ach("mine_all_pickaxes", "🧰", "Полный арсенал кирок",
         ...
         name_en='Full Pickaxe Arsenal', desc_en='Acquire all pickaxes'),
    ...
    _ach("mine_netherite_pickaxe", "⬛", "Кирка из преисподней",
         ...
         name_en='Pickaxe from the Abyss', desc_en='Acquire a Netherite-tier pickaxe'),
    ...
    _ach("mine_all_durations", "⏱", "Хронометрист",
         ...
         name_en='Timekeeper', desc_en='Unlock all expedition durations'),
    ...
    _ach("mine_sessions_10", "📦", "Марафонец",
         ...
         name_en='Marathoner', desc_en='Fully complete 10 mining sessions'),
    ...
    _ach("mine_sessions_50", "🌙", "Бессонная смена",
         ...
         name_en='Sleepless Shift', desc_en='Fully complete 50 mining sessions'),
    ...
    _ach("mine_early_stop", "⏹", "Нетерпеливый",
         ...
         name_en='Impatient', desc_en='Stop an expedition early'),
    ...
    _ach("mine_ore_1000", "🪵", "Добытчик",
         ...
         reward_coins=10_000, reward_xp=50,
         name_en='Gatherer', desc_en='Mine 1,000 units of ore in total'),
    ...
    _ach("mine_ore_100000", "📦", "Оптовик",
         ...
         name_en='Wholesaler', desc_en='Mine 100,000 units of ore in total'),
    ...
    _ach("mine_ore_1000000", "🏭", "Промышленник",
         ...
         name_en='Industrialist', desc_en='Mine 1,000,000 units of ore in total'),
    ...
    _ach("mine_first_iron", "⚙️", "Первое железо",
         ...
         name_en='First Iron', desc_en='Mine iron for the first time'),
    ...
    _ach("mine_first_silver", "🩶", "Серебряная жила",
         ...
         name_en='Silver Vein', desc_en='Mine silver for the first time'),
    ...
    _ach("mine_first_diamond", "💎", "Первый алмаз",
         ...
         name_en='First Diamond', desc_en='Mine a diamond for the first time'),
    ...
    _ach("mine_first_mithril", "🔮", "Мифриловая жила",
         ...
         name_en='Mithril Vein', desc_en='Mine mithril for the first time'),
    ...
    _ach("mine_first_uranium", "☢️", "Радиоактивная находка",
         ...
         name_en='Radioactive Find', desc_en='Mine uranium for the first time'),
    ...
    _ach("mine_first_amethyst", "💜", "Фиолетовый блеск",
         ...
         name_en='Purple Gleam', desc_en='Mine amethyst for the first time'),
    ...
    _ach("mine_first_jade", "🟢", "Нефритовый секрет",
         ...
         name_en='Jade Secret', desc_en='Mine jade for the first time'),
    ...
    _ach("mine_first_emerald", "🌿", "Изумрудная жила",
         ...
         name_en='Emerald Vein', desc_en='Mine an emerald for the first time'),
    ...
    _ach("mine_first_obsidian", "💀", "Чёрное стекло",
         ...
         name_en='Black Glass', desc_en='Mine obsidian for the first time'),
    ...
    _ach("mine_first_sapphire", "🔷", "Сапфировая мечта",
         ...
         name_en='Sapphire Dream', desc_en='Mine a sapphire for the first time — the rarest ore in the game'),
    ...
    _ach("mine_sold_100m", "🏦", "Шахтный магнат",
         ...
         name_en='Mining Tycoon', desc_en='Earn a total of 100,000,000 coins from selling ore'),
    ...
    _ach("hunt_first_hit", "🗡", "Первая кровь",
         ...
         reward_coins=1_000, reward_xp=10,
         name_en='First Blood', desc_en='Land your first hit on a boss'),
    ...
    _ach("hunt_first_kill", "💀", "Охотник",
         ...
         reward_coins=10_000, reward_xp=50,
         name_en='Hunter', desc_en='Kill your first boss'),
    ...
    _ach("hunt_kills_10", "⚔️", "Опытный охотник",
         ...
         reward_coins=50_000, reward_xp=150,
         name_en='Seasoned Hunter', desc_en='Kill 10 bosses'),
    ...
    _ach("hunt_kills_100", "☠️", "Гроза боссов",
         ...
         name_en='Bane of Bosses', desc_en='Kill 100 bosses'),
    ...
    _ach("hunt_first_sword", "🗡", "Вооружён",
         ...
         name_en='Armed', desc_en='Buy your first sword'),
    ...
    _ach("hunt_all_swords", "🏆", "Коллекционер клинков",
         ...
         name_en='Blade Collector', desc_en='Collect every sword in the arsenal'),
    ...
    _ach("arsenal_gift", "🎁", "Щедрая рука",
         ...
         name_en='Generous Hand', desc_en='Gift or transfer a sword to another player'),
    ...
    _ach("arsenal_rent_out", "📤", "Арендодатель",
         ...
         reward_coins=5_000, reward_xp=25,
         name_en='Landlord', desc_en='Rent out a sword to another player'),
    ...
    _ach("arsenal_rent_in", "📥", "Арендатор",
         ...
         reward_coins=5_000, reward_xp=25,
         name_en='Tenant', desc_en='Rent a sword from another player'),
    ...
    _ach("duel_first_win", "🥇", "Первая победа",
         ...
         reward_coins=5_000, reward_xp=30,
         name_en='First Victory', desc_en='Win your first duel'),
    ...
    _ach("duel_wins_10", "🤺", "Дуэлянт",
         ...
         name_en='Duelist', desc_en='Win 10 duels'),
    ...
    _ach("duel_wins_50", "🗡️", "Мастер клинка",
         ...
         name_en='Blade Master', desc_en='Win 50 duels'),
    ...
    _ach("duel_wins_100", "👊", "Ветеран арены",
         ...
         name_en='Arena Veteran', desc_en='Win 100 duels'),
    ...
    _ach("duel_wins_500", "🏟", "Гладиатор",
         ...
         name_en='Gladiator', desc_en='Win 500 duels'),
    ...
    _ach("duel_wins_1000", "🏆", "Легенда арены",
         ...
         name_en='Arena Legend', desc_en='Win 1,000 duels'),
    ...
    _ach("duel_title_max", "👑", "Вечный победитель",
         ...
         name_en='Eternal Champion', desc_en='Reach the highest duelist title — “Eternal Champion” (700 wins)'),
    ...
    _ach("duel_first_loss", "🩹", "Первый урок",
         ...
         reward_coins=2_000, reward_xp=15,
         name_en='First Lesson', desc_en='Lose your first duel — losses teach too'),
    ...
    _ach("duel_battles_100", "⚔️", "Ветеран боёв",
         ...
         reward_coins=100_000, reward_xp=250,
         name_en='Battle Veteran', desc_en='Fight 100 duels (wins + losses)'),
    ...
    _ach("duel_battles_500", "🎖", "Закалённый боец",
         ...
         name_en='Hardened Fighter', desc_en='Fight 500 duels (wins + losses)'),
    ...
    _ach("duel_gear_first", "🎽", "Первая броня",
         ...
         name_en='First Armor', desc_en='Acquire your first duel gear item'),
    ...
    _ach("duel_gear_full_set", "🛡️", "Полный комплект",
         ...
         reward_coins=50_000, reward_xp=150,
         name_en='Full Set', desc_en='Equip all 5 gear slots at once'),
    ...
    _ach("duel_gear_collector", "🧰", "Коллекционер снаряжения",
         ...
         name_en='Gear Collector', desc_en='Acquire all available duel gear'),
    ...
    _ach("duel_skill_first", "🔮", "Первое заклинание",
         ...
         name_en='First Spell', desc_en='Acquire your first combat skill'),
    ...
    _ach("duel_skills_all", "🧙", "Мастер всех искусств",
         ...
         name_en='Master of All Arts', desc_en='Learn every duel combat skill'),
    ...
    _ach("pets_first", "🐣", "Друг найден",
         ...
         reward_coins=3_000, reward_xp=20,
         name_en='Friend Found', desc_en='Get your first pet'),
    ...
    _ach("pets_5", "🐾", "Зоопарк",
         ...
         name_en='Zoo', desc_en='Collect 5 different pets'),
    ...
    _ach("pets_all", "🦄", "Повелитель зверей",
         ...
         name_en='Beastmaster', desc_en='Collect every pet'),
    ...
    _ach("refs_1", "👤", "Пригласил друга",
         ...
         reward_coins=5_000, reward_xp=30,
         name_en='Invited a Friend', desc_en='Invite 1 referral'),
    ...
    _ach("refs_5", "👥", "Рекрутер",
         ...
         reward_coins=25_000, reward_xp=100,
         name_en='Recruiter', desc_en='Invite 5 referrals'),
    ...
    _ach("refs_25", "📣", "Посол",
         ...
         name_en='Ambassador', desc_en='Invite 25 referrals'),
    ...
    _ach("refs_100", "🌍", "Легенда рефералки",
         ...
         name_en='Referral Legend', desc_en='Invite 100 referrals'),
    ...
    _ach("donate_first", "💎", "Спонсор",
         ...
         name_en='Sponsor', desc_en='Make your first donate purchase'),
    ...
    _ach("donate_vip", "👑", "Элита",
         ...
         reward_coins=50_000, reward_xp=100,
         name_en='Elite', desc_en='Get VIP status'),
    ...
    _ach("deposit_first_open", "🏦", "Инвестор",
         ...
         reward_coins=5_000, reward_xp=25,
         name_en='Investor', desc_en='Open your first deposit'),
    ...
    _ach("deposit_first_claim", "💹", "Терпеливый капиталист",
         ...
         reward_coins=10_000, reward_xp=40,
         name_en='Patient Capitalist', desc_en='Claim a matured deposit'),
    ...
    _ach("misc_promo", "🎟", "Охотник за скидками",
         ...
         reward_coins=1_000, reward_xp=10,
         name_en='Deal Hunter', desc_en='Activate a promo code'),
